...
class StopSign(RoadObject):
    """A stop sign as a narrow line object on the road."""

    LENGTH: float = 4  # Length of the stop sign
    WIDTH: float = 0.2  # Width of the stop sign
...
class YellowSignal(RoadObject):
    """A yellow signal indicating caution for vehicles."""

    LENGTH: float = 4  # Length of the yellow signal
    WIDTH: float = 0.2  # Width of the yellow signal
